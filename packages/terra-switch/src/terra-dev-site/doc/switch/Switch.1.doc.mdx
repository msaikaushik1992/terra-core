...
The switch component provides users a way to trigger actions in the UI.
...
The `action` variant is intended for specific solutions in which a non-inline floating switch sits above the page content in a fixed position.
